...
module.exports = {
  run: async (outputPath) => {
    ...
    const { stderr: setEnvError } = await exec('defaults write com.apple.screencapture show-thumbnail -bool false && defaults write com.apple.dock orientation -string bottom && killall Dock')
    if (setEnvError) {
    ...
    try {
      await compressPngImage(screenshot, outputPath, 'bottom')
